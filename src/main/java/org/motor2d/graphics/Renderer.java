...
////import org.motor2d.model.TilemapLayer;
...
//    }
//
//    // Punto de entrada — dibuja toda la escena
...
//
//        try {
//            // Determinar qué imagen dibujar
//            String imagePath = sprite.getSpritePath();
//
//            // Si tiene animación activa usamos el frame actual
...
//
//            int drawWidth  = (int)(sprite.getFrameWidth()
//                    * transform.getScaleX() * camara.getZoom());
//            int drawHeight = (int)(sprite.getFrameHeight()
//                    * transform.getScaleY() * camara.getZoom());
//
//            // Aplicar flip y rotacion
...
//                        drawWidth / 2.0, drawHeight / 2.0);
//            }
//
//            // Flip horizontal
//            if (sprite.isFlipX()) {
//                at.translate(drawWidth, 0);
//                at.scale(-1, 1);
//            }
//
//            // Flip vertical
//            if (sprite.isFlipY()) {
//                at.translate(0, drawHeight);
//                at.scale(1, -1);
//            }
//
...
//                .sorted((a, b) ->
//                        Integer.compare(a.getZOrder(), b.getZOrder()))
...
//            renderLabel(g2, label, x, y);
//        } else if (element instanceof UIButton button) {
//            renderButton(g2, button, x, y);
//        } else if (element instanceof UIImage image) {
//            renderUIImage(g2, image, x, y);
//        }
//    }
//
//    private void renderLabel(Graphics2D g2, UILabel label,
//                             float x, float y) {
...
//    }
//
//    private void renderButton(Graphics2D g2, UIButton button,
//                              float x, float y) {
//        g2.setColor(GameColor.fromHex(button.getNormalColor()).toAwtColor());
//        g2.fillRoundRect((int) x, (int) y,
//                (int) button.getWidth(), (int) button.getHeight(), 10, 10);
//
//        g2.setColor(GameColor.fromHex(button.getTextColor()).toAwtColor());
//        g2.setFont(new Font("Arial", Font.PLAIN, button.getFontSize()));
//        g2.drawString(button.getText(),
//                x + 10,
//                y + button.getHeight() / 2f + button.getFontSize() / 2f);
//    }
//
//    private void renderUIImage(Graphics2D g2, UIImage image,
//                               float x, float y) {
//        try {
...
//        } catch (IOException e) {
//            renderPlaceholder(g2, (int) x, (int) y,
...
//    }
//
//    private void renderPlaceholder(Graphics2D g2, int x, int y,
